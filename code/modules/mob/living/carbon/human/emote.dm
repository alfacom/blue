...
/mob/living/carbon/human/verb/set_flavor()
	...
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["general"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=head'>Head:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["head"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=face'>Face:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["face"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=eyes'>Eyes:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["eyes"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=torso'>Body:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["torso"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=arms'>Arms:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["arms"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=hands'>Hands:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["hands"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=legs'>Legs:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["legs"]))
	HTML += "<br>"
	HTML += "<a href='byond://?src=\ref[src];flavor_change=feet'>Feet:</a> "
	HTML += cp1251_to_utf8(TextPreview(flavor_texts["feet"]))
	HTML += "<br>"
	HTML += "<hr />"
