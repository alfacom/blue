...
/datum/antagonist/revolutionary
	...
	restricted_jobs = list("Internal Affairs Agent", "AI", "Cyborg","Captain", "Head of Personnel", "Security Commissioner", "Chief Engineer", "Research Director", "Chief Medical Officer")
	protected_jobs = list("Brig Overseer", "Investigator", "Forensic Technician", "Colonial Officer", "Colonial Senior Officer")
